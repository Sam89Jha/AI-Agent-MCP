...
# Note: Bedrock Agent resources are created via AWS CLI in deploy.sh
# as Terraform provider doesn't support them yet
...
# Note: Agent ID and Alias ID will be created via AWS CLI and stored in variables 